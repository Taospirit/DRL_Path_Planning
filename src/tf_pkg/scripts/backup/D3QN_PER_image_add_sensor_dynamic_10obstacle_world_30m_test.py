...
##region INIT Network
    ...
    def init_sess(self):
        ...
        if check_save == 'y':
            ...
            path = '/home/lintao/projects/DRL_Path_Planning/src/tf_pkg/scripts/saved_networks/10_D3QN_PER_image_add_sensor_obstacle_world_30m_2_2019_06_02'
            dir_path = '/home/lintao/projects/DRL_Path_Planning/src/tf_pkg/scripts/saved_networks/'
            filename = '20190602'
            # saver.restore(sess, self.load_path + "/model.ckpt")
            saver.restore(sess, dir_path + filename + "/model.ckpt")
            # saver.restore(sess, dir_path + filename)
